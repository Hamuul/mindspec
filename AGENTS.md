...
### Plan Mode
- **Artifact**: `docs/specs/<id>/plan.md` — created from [`docs/templates/plan.md`](docs/templates/plan.md) at Plan Mode start (`status: Draft`), iteratively edited, approved via frontmatter state change (`status: Approved` + `approved_at`, `approved_by`, `bead_ids`, `adr_citations`)
